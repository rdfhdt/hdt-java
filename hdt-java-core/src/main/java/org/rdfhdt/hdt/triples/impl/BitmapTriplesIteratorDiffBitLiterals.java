...
public class BitmapTriplesIteratorDiffBitLiterals implements BitmapTriplesIteratorDiffBit {
    ...
    private long count;
    public BitmapTriplesIteratorDiffBitLiterals(HDT hdtOriginal, Bitmap deleteBitmap, IteratorTripleID iterator){
