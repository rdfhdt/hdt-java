...
/**
 * Implementation of the {@link BitmapTriplesIteratorDiffBit} for multiple section dictionaries
 */
public class MultipleSectionBitmapTriplesIteratorDiffBit implements BitmapTriplesIteratorDiffBit {
    ...
    public MultipleSectionBitmapTriplesIteratorDiffBit(HDT hdtOriginal, Bitmap deleteBitmap, IteratorTripleID iterator) {
